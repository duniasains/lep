...
<select name="sekolah" class="form-control">
    <option value="mhssd">Demo2</option>
</select>    
...
<div style="text-align:center;padding-top:10px;">
	<div style="font-size:14px;">As Supervisor , username : <b>supervisor</b>, password : <b>demo</b></div>
	<div style="font-size:14px;">As Teacher , username : <b>gurudemo</b>, password : <b>demo</b></div>
	<div style="font-size:14px;">As Student , username : <b>muriddemo</b>, password : <b>demo</b></div>
</div>
<?
